    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <p className="mx-auto mt-10 max-w-4xl text-lg leading-relaxed text-gray-400">
          ORION (On Birthday RISET Goes On) merupakan
          rangkaian acara tahunan dalam rangka memperingati
          Hari Ulang Tahun UKMF RISET. Mengusung semangat kolaborasi, inovasi, dan
          pengembangan kapasitas, ORION menjadi wadah bagi
          generasi muda untuk bertukar gagasan,
          mengembangkan potensi, serta memberikan kontribusi
          nyata bagi masyarakat melalui berbagai kegiatan
