export default function EssayCTA() {
  return (
    <section
      id="upload"
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-8 max-w-2xl text-lg text-gray-400">
          Tuangkan gagasan terbaikmu, berikan solusi
          inovatif untuk Indonesia, dan jadilah bagian
          dari generasi yang membawa perubahan.
        </p>
