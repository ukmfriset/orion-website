...
export default function EssayJudges() {
  const judges: Judge[] = [
    {
      image: "/images/judges/juri1.jpeg",
    ...
    {
      image: "/images/judges/juri2.jpeg",
    ...
    {
      image: "/images/judges/juri3.jpeg",
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-gray-400">
            Penilaian dilakukan oleh akademisi dan praktisi
            profesional yang memiliki pengalaman riset,
            publikasi ilmiah, serta kontribusi nyata di
            bidangnya.
          </p>
        </div>
